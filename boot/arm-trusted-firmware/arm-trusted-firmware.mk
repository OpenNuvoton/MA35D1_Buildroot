...
ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D16A887C_LFBGA-312_MCP_WinbondDDR3L_256M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x00120000
else ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D14F884_LQFP-216_MCP_WinbondDDR3L_256M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x00300000
else ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D14F984_LQFP-216_MCP_WinbondDDR3L_512M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x00310000
else ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D16A887C_LFBGA-312_MCP_WinbondDDR3L_256M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x00120000
else ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D16AI87C_LFBGA-312_MCP_WBDDR3L_256M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x002a0000
else ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D16AJ87C_LFBGA-312_MCP_WBDDR3L_512M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x00160000
else ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D16F787C_LQFP-216_MCP_WinbondDDR2_128M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x00200000
else ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D16F887C_LQFP-216_MCP_WinbondDDR3L_256M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x00220000
else ifeq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_CUSTOM_DDR)),MA35D16F987C_LQFP-216_MCP_WinbondDDR3L_512M_1PCS.h)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += PID_CHECK=0x00240000
endif
