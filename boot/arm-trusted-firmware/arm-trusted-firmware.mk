...
else ifeq ($(TFA_CPU800_ZT1G),y)
	BR2_TARGET_ARM_TRUSTED_FIRMWARE_INTREE_DTS_NAME="ma35d1-cpu800-zt-1g"
else ifeq ($(TFA_CPU800_MC1G),y)
	BR2_TARGET_ARM_TRUSTED_FIRMWARE_INTREE_DTS_NAME="ma35d1-cpu800-mc-1g"
else ifeq ($(TFA_CPU800_ISSI1G),y)
	BR2_TARGET_ARM_TRUSTED_FIRMWARE_INTREE_DTS_NAME="ma35d1-cpu800-issi-1g"
else ifeq ($(TFA_CPU1G_ZT1G),y)
	BR2_TARGET_ARM_TRUSTED_FIRMWARE_INTREE_DTS_NAME="ma35d1-cpu1g-zt-1g"
else ifeq ($(TFA_CPU1G_MC1G),y)
	BR2_TARGET_ARM_TRUSTED_FIRMWARE_INTREE_DTS_NAME="ma35d1-cpu1g-mc-1g"
else ifeq ($(TFA_CPU1G_ISSI1G),y)
	BR2_TARGET_ARM_TRUSTED_FIRMWARE_INTREE_DTS_NAME="ma35d1-cpu1g-issi-1g"
endif
