...
LINUX_HEADERS_CUSTOM_TARBALL = $(call qstrip,$(BR2_LINUX_KERNEL_MA35D1))
LINUX_HEADERS_CUSTOM_TARBALL_LOCATION = $(call github,OpenNuvoton,MA35D1_linux-5.10.y,$(call qstrip,$(BR2_TARGET_KERNEL_MA35D1_VERSION)))/MA35D1_linux-5.10.y-$(call qstrip,$(BR2_TARGET_KERNEL_MA35D1_VERSION)).tar.gz
LINUX_HEADERS_SOURCE = $(notdir $(LINUX_HEADERS_CUSTOM_TARBALL_LOCATION))
LINUX_HEADERS_SITE = $(patsubst %/,%,$(dir $(LINUX_HEADERS_CUSTOM_TARBALL_LOCATION)))
else ifeq ($(BR2_LINUX_KERNEL_MA35D1_5_4_VERSION),y)
LINUX_HEADERS_CUSTOM_TARBALL = $(call qstrip,$(BR2_LINUX_KERNEL_MA35D1))
LINUX_HEADERS_CUSTOM_TARBALL_LOCATION = $(call github,OpenNuvoton,MA35D1_linux-5.4.y,$(call qstrip,$(BR2_TARGET_KERNEL_MA35D1_VERSION)))/MA35D1_linux-5.4.y-$(call qstrip,$(BR2_TARGET_KERNEL_MA35D1_VERSION)).tar.gz
LINUX_HEADERS_SOURCE = $(notdir $(LINUX_HEADERS_CUSTOM_TARBALL_LOCATION))
LINUX_HEADERS_SITE = $(patsubst %/,%,$(dir $(LINUX_HEADERS_CUSTOM_TARBALL_LOCATION)))
